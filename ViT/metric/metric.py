...
if __name__ == "__main__":
    ...
    # pretrained_or_not = "not_pretrained"
    # pretrained_or_not = "pretrained"
    # pretrained_or_not = "pretrained_not_finetuning"
    # pretrained_or_not = "not_pretrained_not_finetuning"
    

    print(f"{augmentation_or_not}_{pretrained_or_not}")
    file_path = f"../results/{augmentation_or_not}/{pretrained_or_not}/inference_results.csv"  # 파일 경로 설정
